...
- **Independent rules review:** recorded in `docs/reviews/2026-09-17-etr-rules-independent-review.md` (see below) — spawned as a separate reviewer subagent per the board's requirement that the author cannot self-certify.
