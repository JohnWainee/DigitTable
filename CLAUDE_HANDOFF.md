...
**Independent review requirement (not yet satisfied):** per `AGENTS.md`'s "do not call a non-trivial change complete until it has been independently reviewed," this fix has *not* been independently reviewed — record a second-pass review here (a fresh reviewer, not this session) before treating it as closed, following the pattern in `docs/reviews/2026-09-18-sonnet-d-reskin-independent-review.md`.
