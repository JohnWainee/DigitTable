...
- **Status:** The six playable character sheets now match the owner-supplied sourcebook roster (Iryna, Nicole, Cosgrave, Chuck, Astrid, and Flint), including equipment, abilities, advances, injuries, Last Stands, ability bonuses, and typed utility-item behavior. Commit `5e8907b` is deployed to Firebase Hosting and all five callable Functions at <https://digitable.signal-bleed.com>. A fresh-room live smoke passed all 17 GM/player/table steps after the Functions update, and a new deployed-session rerun passed on 2026-09-19. Physical-device evidence remains open for John.
...
- **Last updated:** 2026-09-19 by Codex after independently rerunning the deployed GM/player/table smoke
